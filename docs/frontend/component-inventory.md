...
- Project and One Click workspaces own shot plan generation, editing, media attachment, raw Prompt/Request/Response review, and saving through project-scoped APIs.
...
- In One Click Step 3, use only project-scoped shot plans generated from the wizard.
...
- Admin attribute pages use shared Story, Scenario, and Shots catalog components.
...
- Project and One Click use the same attribute selection pattern for Story, Scenario, and Shots: required attributes keep one selected option; optional attributes may be empty.
